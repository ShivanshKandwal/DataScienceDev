...
export const NeuralBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const particleCount = Math.min(60, Math.floor((width * height) / 25000)); // scale with screen size
    ...
    class Particle {
      ...
      constructor() {
        ...
        // Randomly assign a color from our artistic palette
        const colors = [
    ...
    const drawConnections = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        if (distMouse < mouse.radius - 30) {
          const alpha = (1 - distMouse / (mouse.radius - 30)) * 0.15;
          ctx.beginPath();
